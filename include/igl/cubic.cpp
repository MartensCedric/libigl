...
// for ray_bezier_intersect_2d (Vec2 = Matrix<Scalar,1,2>)
template void igl::cubic<Eigen::Matrix<double, -1, -1, 0, -1, -1>, Eigen::Matrix<double, 1, 2, 1, 1, 2>>(Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const&, Eigen::Matrix<double, 1, 2, 1, 1, 2>::Scalar const&, Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 2, 1, 1, 2>>&);
template void igl::cubic<Eigen::Matrix<double, 4, 2, 0, 4, 2>, Eigen::Matrix<double, 1, 2, 1, 1, 2>>(Eigen::MatrixBase<Eigen::Matrix<double, 4, 2, 0, 4, 2>> const&, Eigen::Matrix<double, 1, 2, 1, 1, 2>::Scalar const&, Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 2, 1, 1, 2>>&);
template void igl::cubic<Eigen::Matrix<float, 4, 2, 0, 4, 2>, Eigen::Matrix<float, 1, 2, 1, 1, 2>>(Eigen::MatrixBase<Eigen::Matrix<float, 4, 2, 0, 4, 2>> const&, Eigen::Matrix<float, 1, 2, 1, 1, 2>::Scalar const&, Eigen::PlainObjectBase<Eigen::Matrix<float, 1, 2, 1, 1, 2>>&);
// generated by autoexplicit.sh
